    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <div class="row row-cards mb-3">
                <div class="col-12">
                    <div class="card" style="background: linear-gradient(135deg, #0368c9 0%, #6ecff6 100%); border: none; box-shadow: 0 20px 45px rgba(3, 104, 201, 0.25);">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <div style="background: rgba(255, 255, 255, 0.2); padding: 12px; border-radius: 12px; display: inline-block; border: 1px solid rgba(255, 255, 255, 0.3);">
                                                <img src="{{ asset('assets/lanal/logo-event/Logg4.png') }}" 
                                                 alt="Logo" 
                                                     style="max-height: 80px; width: auto; display: block; filter: drop-shadow(0 8px 16px rgba(0, 0, 0, 0.2));">
                                            </div>
                                        </div>
