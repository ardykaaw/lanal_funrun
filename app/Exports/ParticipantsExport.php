...
class ParticipantsExport
{
    ...
    public function export()
    {
        ...
        $sheet->setCellValue('C' . $row, 'DATA PESERTA TERKONFIRMASI - DANLANAL KENDARI RUN 2025');
        ...
        // Set column widths
        $widths = [5, 15, 15, 15, 12, 25, 18, 15, 12, 12, 15, 12, 15, 30, 15, 15, 10, 10, 15, 20, 15, 20, 30, 18];
        $col = 'A';
